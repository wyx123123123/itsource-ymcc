...
@RocketMQMessageListener(
        consumerGroup="service-course-payresult-consumer",//消费者组名
...
public class PayResult2CourseConsumer implements RocketMQListener<MessageExt> {
    ...
    public void onMessage(MessageExt messageExt) {
        ...
        courseUserLearnService.payResultHandle(orderDto);
    }
}
