package cn.itsource.mybatisgent;
...
public class GenteratorCode {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        pc.setController("web.controller"); //cn.itsource.web.controller
        ...
        focList.add(new FileOutConfig("/templates/controller.java.vm") {
            ...
            public String outputFile(TableInfo tableInfo) {
                //合并好的内容输出到哪儿？
                return rb.getString("OutputDir")+ "/cn/itsource/web/controller/" + tableInfo.getEntityName() + "Controller.java";
            }
        });
        //query的输出配置
